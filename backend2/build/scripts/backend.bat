...
set CLASSPATH=%APP_HOME%\lib\backend-1.0.jar;%APP_HOME%\lib\gson-2.10.1.jar;%APP_HOME%\lib\mysql-connector-j-9.3.0.jar


@rem Execute backend
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %BACKEND_OPTS%  -classpath "%CLASSPATH%" MusicServer %*
